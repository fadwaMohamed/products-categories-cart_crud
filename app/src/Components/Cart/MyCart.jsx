...
const MyCart = () => {
  ...
  if (orders) {
    return (
      <>
        <h4 className="m-auto text-center my-3 w-25 border-bottom pb-2">
          {" "}
          My order{" "}
        </h4>
        <div
              ...
              return (
                <Card
                  ...
                  actions={[
                    <EditOutlined
                      key="edit"
                      onClick={() => navigate(`/cart/addToCart/${order.id}`)}
                    />,
                    <DeleteOutlined
                      key="delete"
                ...
                >
                  <Meta
                    title={
                      <h4 className="text-center" style={{ color: "#1890ff" }}>
                        {" "}
                        {order.productname}{" "}
                      </h4>
                    }
                    description={
                      <>
                        <h6>
                          {" "}
                          <span className="fs-5" style={{ color: "#1890ff" }}>
                            {order.quantity}
                          </span>{" "}
                          pieces
                        </h6>
        ...
        <Routes>
          <Route
            path="/addToCart/:id"
            element={<AddToCart getOrders={getOrders} />}
          />
        </Routes>
      </>
    );
